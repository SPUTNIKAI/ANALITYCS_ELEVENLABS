# Leads Display Capability

The leads display capability provides a web interface for viewing and managing all leads from the database.
...
- **AND** metadata includes: current_page, total_pages, total_count
